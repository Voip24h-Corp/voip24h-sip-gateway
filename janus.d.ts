...
declare namespace JanusJS {
	...
	class Voip24h {
		static initGateWay(): void;
		static registerSip(ipSip: string, sip: string, secret: string): void;
		...
		toggleHold(): void;
		toggleMute(): void;
		transfer(transferToNumber: number): void;
		sendDtmfToSip(number: number): void;
		isMute(): boolean;
		isHold(): string;
		isRegistered(): string;
		release(): void;
...
export default JanusJS.Voip24h;
export { JanusJS };
